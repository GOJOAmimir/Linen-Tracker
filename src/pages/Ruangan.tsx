...
export default function RuanganPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 dark:text-white text-center mb-8">
        Informasi Ruangan
      </h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 items-stretch">
        {menu.map((item, i) => (
          <button
            ...
            className="
            group relative flex flex-col justify-between rounded-2xl p-6 min-h-[170px] text-left
            ...
            shadow-lg shadow-[0_8px_30px_rgba(0,0,0,0.06)]
            dark:shadow-[0_8px_30px_rgba(36,214,173,0.06)]
          ...
          >
            ...
            <div className="flex items-start gap-4">
              <div className="flex-shrink-0">
                <div
                  className="h-12 w-12 rounded-lg flex items-center justify-center
                              bg-gradient-to-br from-[#24D6AD]/20 to-[#24D6AD]/10
                              ring-1 ring-gray-200 dark:ring-white/6"
                >
                  <svg
                    width="22"
                    height="22"
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-200/90">
                  {item.desc}
                </p>
              </div>
            </div>
            ...
            <div className="mt-4 flex items-center justify-between">
              ...
              <span className="text-xs text-gray-500 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-white/90 transition">
                →
              </span>
            </div>
          </button>
